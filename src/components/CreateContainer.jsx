...
function CreateContainer() {
    ...
    const uploadImage = (e) => {
        ...
        uploadTask.on("state_changed",
            ...
            (error) => {
                setFields(true);
                setMsg("Error while loading : Please Try Again!");
            ...
            flex flex-col items-center justify-center gap-4">
                {
                    fields && (
                        ...
                        ${alertStatus === "danger" ? "bg-red-400 text-red-600" : "bg-emerald-400 text-emerald-800"}`}>
                            {msg}
                        </motion.p>
                    )
                }
                ...
                <div className="group flex justify-center items-center flex-col border-2 border-dotted border-gray-300
                 w-full h-225 md:h-420 cursor-pointer">
                    {isLoading ? <Loader /> : <>
                        {!imageAsset ? <>
