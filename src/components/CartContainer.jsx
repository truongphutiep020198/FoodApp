...
import { MdOutlineKeyboard, MdOutlineKeyboardBackspace } from "react-icons/md";
...
function CartContainer() {
    ...
    // const filterCartItem = cartItems.filter((item, index) => cartItems.indexOf(item) === index);
        ...
        z-[100]">
            ...
            items-center justify-evenly px-8 py-2">
                        ...
                        <div className=" w-full flex item-center justify-between">
                            ...
                            <p className=" text-gray-200 text-xl font-semibold">${tot + 1}</p>
                        </div>
                        {user ? (
                            <motion.button
                                whileTap={{ scale: 0.8 }}
